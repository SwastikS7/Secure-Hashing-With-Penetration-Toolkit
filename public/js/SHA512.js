...
//     return {
//         encryptor: function(str) {
//             return SHA512(str);
//         }
//     };
// }));

// Keep all the existing SHA512 function implementation, then at the end add:

// Then, create a global object with the correct structure
const SHA512Module = {
    encryptor: SHA512  // Direct reference to the function
};

// Make it globally available
globalThis.SHA512 = SHA512Module;

// For Node.js compatibility
if (typeof module !== 'undefined' && module.exports) {
    module.exports = SHA512Module;
}